...
Bounds use desktop coordinates with origin at the top-left of the primary display. Windows uses physical pixels; macOS and Linux use logical points where available. Use a screenshot's coordinate methods to map bounds onto captured pixels. Note:
