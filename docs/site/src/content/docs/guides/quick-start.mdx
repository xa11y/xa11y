...
<Tabs syncKey="lang">
  <TabItem label="Rust">
    ...
    fn main() -> Result<()> {
        ...
        println!("Children: {}", tree.root().children.len());
...
<Tabs syncKey="lang">
  <TabItem label="Rust">
    ...
    println!("Found: {}", submit.name.as_deref().unwrap_or("unnamed"));
  ...
  <TabItem label="Python">
    ...
    submit = tree.query_one("button[name='Submit']")
...
<Tabs syncKey="lang">
  <TabItem label="Rust">
    ...
    let locator = tree.locator("button[name='Submit']");

    // Press the button
    locator.press(&*provider)?;

    // Type into a text field
    let search = tree.locator("textfield[name^='Search']");
    search.set_value(&*provider, "hello world")?;
    ```
  </TabItem>
  <TabItem label="Python">
    ```python
