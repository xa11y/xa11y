...
<Tabs syncKey="lang">
  <TabItem label="Rust">
    ...
    fn main() -> Result<()> {
        ...
        let btn = calc.locator("button[name='=']").node()?;
        ...
        println!("Result: {:?}", result.node()?.value);
  ...
  <TabItem label="Python">
    ...
    # Find all buttons via locator
    buttons = calc.locator("button").nodes()
    print(f"Found {len(buttons)} buttons")

    # Read properties from a specific node
    btn = calc.locator("button[name='=']").node()
    ...
    print(f"Result: {result.node().value}")
